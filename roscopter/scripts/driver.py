...
#*******************************************************************************
sys.path.insert(0, os.path.join(os.path.dirname(os.path.realpath(__file__)), '../src/mavlink/pymavlink'))
import mavutil
...
def send_rc_cb(data):
    ...
    # rospy.loginfo ("sending rc: %s"%data) # HEREHEREHERE
...
#            master.mav.set_mode_send(master.target_system, mavutil.mavlink.MAV_MODE_FLAG_CUSTOM_MODE_ENABLED, LAND)
        ...
        #rospy.loginfo ("RETURN RC CONTROL") # HEREHEREHERE
